export default function Introduce(){
    ...
    <div className="w-full flex flex-row h-full items-center">
      ...
      <div className="flex flex-col grow h-[90%] pl-[5%] justify-start">
        <h1 className="font-semibold text-3xl" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">Introduce</h1>
        <div className="divider" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200" />
        <div className="mb-2 flex flex-col space-y-2">
          <h1 className="text-2xl mb-4" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300" >안녕하세요, 웹 프론트엔드 개발자 임동민입니다.</h1>
          <p className="text-md" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400" >신입 프론트엔드 개발자입니다.</p>
          <p className="text-md" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500" >개발자 직무를 선택한 이유</p>
          <p className="text-md" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600" >개발자로써의 성격적 장점 어필</p>
          <p className="text-md" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="700" >이루고싶은 것</p>
          <p className="text-md" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="800" >현재하고있는 노력</p>
        </div>
        <ul className="flex flex-col space-y-1 mt-auto w-fit" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="1000" >
