...
export default function  Strength(){
    ...
    useEffect(() => {
        var c1 = document.getElementById( 'c1' ) as HTMLCanvasElement,
        ...
        function hsla( h:any, s:any, l:any, a:any ) {
        return 'hsla(' + h + ',' + s + '%,' + l + '%,' + a + ')';
        }
    ...
    return (
    <div className="">
    <canvas id="c1" className="opacity-0 absolute -z-10 inset-0"/>
    <canvas id="c2" className="bg-[#000] absolute -z-10 inset-0"/>
